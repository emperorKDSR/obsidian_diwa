...
Current release: **v10.2.1** · See [CHANGELOG.md](./CHANGELOG.md) for release history.
...
The current 10.2.1 line no longer includes the removed Search, AI, Voice, Timeline, Synthesis, Calendar, or Graph Explorer modules.
